...
class CropPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBarChild(title: AppTranslationConstants.videoEditor.tr),
      body: Container(
        child: Container(
  ...
  Widget _buildCropButton(BuildContext context, Fraction? f) {
    ...
    return Flexible(
      child: TextButton(
        ...
        child: Text(f == null ? AppTranslationConstants.loose.tr.capitalize : '${f.numerator}:${f.denominator}'),
      ),
    );
  }
}